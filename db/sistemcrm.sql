...
--
-- Database: sistemcrm
-- Generation Time: 2024-05-15 23:01:03.6910
-- -------------------------------------------------------------
...
CREATE TABLE `detail_transaksi` (
  ...
  `gift_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `gifts` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `nama_gift` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `gambar_gift` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `klaim_poin` (
  ...
  `status` enum('Menunggu','Terklaim','Ditolak') COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `klasifikasigunung` (
  ...
  `gambar_gunung` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `ketinggian` enum('Rendah','Sedang','Tinggi') COLLATE utf8mb4_unicode_ci NOT NULL,
  `kesulitan` enum('Rendah','Sedang','Tinggi') COLLATE utf8mb4_unicode_ci NOT NULL,
  `lama_pendakian` enum('Pendek','Sedang','Panjang') COLLATE utf8mb4_unicode_ci NOT NULL,
  `suhu` enum('Dingin','Sedang','Hangat') COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `kritiksaran` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `user_id` bigint unsigned NOT NULL,
  `isi_kritiksaran` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `produk` (
  ...
  `harga_produk` int NOT NULL,
  `kategori` enum('Pakaian & Celana','Peralatan Outdoor','Peralatan Keamanan','Sepatu & Sandal','Ransel','Jaket & Jas Hujan') COLLATE utf8mb4_unicode_ci NOT NULL,
  `deskripsi` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `merk` enum('Consina','Forester') COLLATE utf8mb4_unicode_ci NOT NULL,
  `ketinggian` enum('Rendah','Sedang','Tinggi') COLLATE utf8mb4_unicode_ci NOT NULL,
  `kesulitan` enum('Rendah','Sedang','Tinggi') COLLATE utf8mb4_unicode_ci NOT NULL,
  `lama_pendakian` enum('Pendek','Sedang','Panjang') COLLATE utf8mb4_unicode_ci NOT NULL,
  `suhu` enum('Dingin','Sedang','Hangat') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `users` (
  ...
  `role` enum('admin','kasir','member','manajer') COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `poin` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `kritiksaran` (`id`, `user_id`, `isi_kritiksaran`, `created_at`, `updated_at`, `tgl_kirim`) VALUES
(4, 10, 'pelayanan nya sangat baik!!', '2024-05-12 15:36:04', '2024-05-12 15:36:04', '2024-05-12'),
(5, 10, 'saya suka berbelanja disini karena banyak gift menarik', '2024-05-12 15:36:21', '2024-05-12 15:36:21', '2024-05-12'),
(6, 10, 'saya suka tempatnya!!', '2024-05-12 15:36:50', '2024-05-12 15:36:50', '2024-05-12');
