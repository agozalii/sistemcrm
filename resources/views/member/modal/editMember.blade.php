<div class="modal fade" id="editMemberr" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content me-5" style="width: 700px;">
            ...
            <form action="{{ route('updateMemberr', $data->id) }}" method="POST" enctype="multipart/form-data">
                @method('PUT')
                @csrf
